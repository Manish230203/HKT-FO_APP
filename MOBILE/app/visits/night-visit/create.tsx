...
import { Moon, Plus, Trash2, ChevronDown, Building, X, Clock } from 'lucide-react-native';
...
export default function CreateNightVisitReportScreen() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setAlertInfo({
        visible: true,
        title: t('night_visit_submitted'),
        message: t('night_visit_success_desc'),
        type: 'success',
      });
    } catch (e: any) {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        {currentStep === 2 && (
          <Card style={styles.stepCard}>
            <Text style={styles.stepTitle}>Officer Night Round Checklist ({templateQuestions.length} Items)</Text>
              ...
              return (
                ...
                >
                  <View style={{ flex: 1, paddingRight: 10 }}>
                    {item.section ? (
                      <Text style={{ fontSize: 10, fontWeight: '700', color: '#3B82F6', marginBottom: 2 }}>
