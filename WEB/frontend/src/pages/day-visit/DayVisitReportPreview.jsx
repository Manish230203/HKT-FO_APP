        ...
        <div className="border-b-2 border-[#1e3a8a] pb-4 mb-4">
          {!hideLogo && (
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h2 className="text-sm font-black tracking-tight text-slate-900 leading-none">Unique Delta Force Security Pvt. Ltd.</h2>
              </div>
            </div>
          )}
          <div className="flex justify-between items-start gap-4">
            ...
            <div className="text-right text-[10px] font-bold text-slate-800 leading-normal uppercase font-mono shrink-0 whitespace-nowrap">
              DATE : {formatDateToDMY(visitDate)} {report?.startTime || "—"} - {report?.endTime || "—"}
            </div>
          </div>
        </div>
      )}
