  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto pb-10">
      ...
      <div className="space-y-6">
        {activeTemplate && (
          <div className="flex flex-col gap-1 bg-slate-100 dark:bg-slate-800/50 dark:bg-slate-900/40 p-4 border rounded-[14px] px-6">
            ...
            <div className="divide-y divide-border">
              {sections.map((sectionName, sIdx) => {
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between hover:bg-slate-50 dark:bg-slate-900/50/50 dark:hover:bg-slate-800/10 px-3 py-1 rounded-lg transition-colors">
                      <div className="flex items-center gap-3">
                        <div
                    ...
                    {isExpanded && (
                      <div className="pl-10 pr-4 py-2 bg-slate-50 dark:bg-slate-900/50/40 dark:bg-slate-800/10 rounded-lg border border-dashed border-border/80 space-y-2 mt-2 ml-7">
      ...
      <Dialog open={isAddQuestionOpen} onOpenChange={setIsAddQuestionOpen}>
        <DialogContent className="rounded-[16px] border border-border bg-card shadow-lg max-w-3xl p-0 overflow-hidden">
                    ...
                    {qType === "yes_no" && (
                      <div className="space-y-2">
                        {qOptions.map((opt, idx) => (
                          ...
                          >
                            <div className="h-4 w-4 rounded-full border border-slate-400 dark:border-slate-600 flex items-center justify-center shrink-0">
                              {idx === 0 && (
          ...
          <div className="flex items-center justify-end gap-2 px-6 py-4 border-t border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50 dark:bg-slate-900/35">
